 ...
 * DatePickerControls
 *
 * Interface.Forms.Controls.DatePicker.html page content scripts. Initialized from scripts.js file.
 *
 *
 */
...
class DatePickerControls {
  ...
  _initBasic() {
    jQuery('#item_buyDate').datepicker({
      format: 'dd.mm.yyyy',
      autoclose: true,
    });
    jQuery('#item_endDate').datepicker({
      format: 'dd.mm.yyyy',
      autoclose: true,
    });
  }
